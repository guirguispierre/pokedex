...
const CATEGORIES = {
  ...
  mod: {
    ...
    commands: [
      ...
      '`/mute <user> <duration> [reason]` — Temporarily mute a user (Discord timeout)',
      '`/unmute <user> [reason]` — Clear a user\'s timeout',
  ...
  fun: {
    ...
    commands: [
      ...
      '`/graveyard board [limit]` — Most deleted messages (shown to everyone)',
      '`/graveyard check [user]` — Deleted-message count for a user',
